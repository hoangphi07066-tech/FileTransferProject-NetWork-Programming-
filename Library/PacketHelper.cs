...
public static class PacketHelper {
    public static byte[] Serialize(TransferPacket packet) {
        ...
        writer.Write(packet.IsResume); // Ghi IsResume
        writer.Write(packet.FileHash); // Ghi FileHash
    ...
    public static TransferPacket Deserialize(byte[] bytes) {
        ...
        var p = new TransferPacket {
            ...
            IsResume = reader.ReadBoolean(), // Đọc IsResume
            FileHash = reader.ReadString() // Đọc FileHash
        };
